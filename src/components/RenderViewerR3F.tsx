...
export default function RenderViewerR3F({ render }: RenderViewerProps) {
  ...
  const [arCapability, setARCapability] = useState<'available' | 'no-files' | 'not-supported'>('not-supported');
  ...
  const getARButtonText = () => {
    switch (deviceType) {
      case 'ios':
        return arCapability === 'available' ? '🥽 Ver en AR (iOS)' : '📱 AR no disponible (falta .usdz)';
      case 'android':
        return arCapability === 'available' ? '🥽 Ver en AR (Android)' : '📱 AR no disponible (falta .glb)';
      case 'desktop':
              ...
              <Card.Body p={8}>
                <Center>
                  <Stack gap={4} textAlign="center" maxW="md">
                    ...
                    <Text color="gray.600">
                      Este modelo está optimizado para Realidad Aumentada nativa en tu dispositivo móvil.
                    </Text>
              ...
              <Card.Body>
                <Stack gap={3}>
                  <Box>
                    ...
                    <Text fontSize="sm" color="gray.600">
                      Toca "Ver en AR" para abrir Quick Look y coloca el modelo en tu espacio real
                    </Text>
                  </Box>
                  ...
                  <Box>
                    ...
                    <Text fontSize="sm" color="gray.600">
                      Toca "Ver en AR" para abrir Scene Viewer de Google y experimentar AR
                    </Text>
                  </Box>
                  ...
                  <Box>
                    ...
                    <Text fontSize="sm" color="gray.600">
                      Comparte este enlace con dispositivos móviles para la experiencia AR completa
                    </Text>
                  </Box>
                </Stack>
              </Card.Body>
